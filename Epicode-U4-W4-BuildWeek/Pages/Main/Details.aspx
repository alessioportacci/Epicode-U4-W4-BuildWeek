...
<div class="">
    ...
    <div class="card" style="">
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <h3 id="DetailsTitle" class="card-title" runat="server" text=""></h3>
                    <p id="DetailsDate" class="card-text" runat="server">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
